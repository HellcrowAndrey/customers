...
public class Customers implements Serializable, TokenInformation {
    ...
    public Customers encodedPassword(String pass) {
        this.pass = pass;
        return this;
    }

    public Customers addRoles(Set<Role> roles) {
        this.roles = roles;
        return this;
    }
    ...
    public Customers isLocked(boolean isLocked) {
        this.isLocked = isLocked;
        return this;
    }
